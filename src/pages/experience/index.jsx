...
const IndustryCard = ({ icon, title, description, count }) => (
  <div className="fade-in-section">
    <div className="bg-white rounded-xl shadow-elegant hover:shadow-elegant-lg p-8 transition-all duration-300 border border-primary-100 hover:border-primary-300 h-full flex flex-col relative overflow-hidden">
      <div className="absolute top-0 right-0 w-32 h-32 bg-primary-50 rounded-bl-full transform origin-top-right transition-all duration-500"></div>
      
      <div className="flex items-center gap-4 mb-6 relative z-10">
        <div className="bg-primary-100 hover:bg-primary-200 text-primary-700 rounded-lg p-4 transition-colors duration-300">
          {icon}
        </div>
      ...
      <h3 className="text-xl md:text-2xl font-serif font-bold text-primary-800 mb-4 relative z-10">{title}</h3>
