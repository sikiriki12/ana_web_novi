            ...
            <div className="md:col-span-8">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h2 className="text-3xl font-serif font-bold text-primary-800 mt-0 mb-4">
                      {t('industry.media.intro.title')}
                    </h2>
                    
                    <p>
                      {t('industry.media.intro.paragraph1')}
                    </p>
                    
                    <p>
                      {t('industry.media.intro.paragraph2')}
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-primary-50 rounded-xl p-8 my-10">
                  <h3 className="text-2xl font-serif font-bold text-primary-800 mb-6">
                    {t('industry.media.approach.title')}
                  </h3>
                  
                  <p>
                    {t('industry.media.approach.paragraph1')}
                  </p>
                  
                  <p className="mb-0">
                    {t('industry.media.approach.paragraph2')}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-serif font-bold text-primary-800 mb-8">
                  {t('industry.media.services.title')}
                </h3>
                
                <div className="grid md:grid-cols-2 gap-8">
                  {t('industry.media.services.items').map((service, index) => (
            ...
            <div className="md:col-span-4">
              ...
              <div className="bg-primary-800 text-white rounded-xl p-8 mb-8">
                <h3 className="text-xl font-serif font-bold mb-4">
                  {t('industry.media.sidebar.cta.title')}
                </h3>
                
                <p className="text-primary-100 mb-6">
                  {t('industry.media.sidebar.cta.description')}
                </p>
              ...
              <div className="bg-primary-50 rounded-xl p-8">
                <h3 className="text-xl font-serif font-bold text-primary-800 mb-4">
                  {t('industry.media.sidebar.whyChooseUs.title')}
                </h3>
                
                <ul className="space-y-4">
                  {t('industry.media.sidebar.whyChooseUs.reasons').map((reason, index) => (
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-serif font-bold text-primary-800 mb-6">
              {t('industry.media.bottomCta.title')}
            </h2>
            
            <p className="text-lg text-secondary-700 mb-8 max-w-3xl mx-auto">
              {t('industry.media.bottomCta.description')}
            </p>
            
            <Link to="/contact" className="btn btn-primary">
              {t('industry.media.bottomCta.buttonText')}
            </Link>
          </div>
        </div>
      </section>
