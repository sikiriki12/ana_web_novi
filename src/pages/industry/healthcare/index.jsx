...
import { FaHospital, FaArrowRight, FaUserMd, FaShieldAlt, FaFileMedical, FaHandshake } from 'react-icons/fa'
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center mb-6 text-primary-300">
              <Link to="/industry" className="hover:text-white transition-colors">
                {t('industry.healthcare.breadcrumb')}
              </Link>
              <span className="mx-3">/</span>
              <span>{t('industry.healthcare.title')}</span>
            </div>
            ...
            <p className="text-xl text-primary-100 mb-8 animate-fade-in animate-delay-200 max-w-3xl mx-auto">
              {t('industry.healthcare.description')}
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="md:col-span-8">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h2 className="text-3xl font-serif font-bold text-primary-800 mt-0 mb-4">
                      {t('industry.healthcare.intro.title')}
                    </h2>
                    
                    <p>
                      {t('industry.healthcare.intro.paragraph1')}
                    </p>
                    
                    <p>
                      {t('industry.healthcare.intro.paragraph2')}
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-primary-50 rounded-xl p-8 my-10">
                  <h3 className="text-2xl font-serif font-bold text-primary-800 mb-6">
                    {t('industry.healthcare.approach.title')}
                  </h3>
                  
                  <p>
                    {t('industry.healthcare.approach.paragraph1')}
                  </p>
                  
                  <p className="mb-0">
                    {t('industry.healthcare.approach.paragraph2')}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-serif font-bold text-primary-800 mb-8">
                  {t('industry.healthcare.services.title')}
                </h3>
                
                <div className="grid md:grid-cols-2 gap-8">
                  {t('industry.healthcare.services.items').map((service, index) => (
            ...
            <div className="md:col-span-4">
              ...
              <div className="bg-primary-800 text-white rounded-xl p-8 mb-8">
                <h3 className="text-xl font-serif font-bold mb-4">
                  {t('industry.healthcare.sidebar.cta.title')}
                </h3>
                
                <p className="text-primary-100 mb-6">
                  {t('industry.healthcare.sidebar.cta.description')}
                </p>
              ...
              <div className="bg-primary-50 rounded-xl p-8">
                <h3 className="text-xl font-serif font-bold text-primary-800 mb-4">
                  {t('industry.healthcare.sidebar.whyChooseUs.title')}
                </h3>
                
                <ul className="space-y-4">
                  {t('industry.healthcare.sidebar.whyChooseUs.reasons').map((reason, index) => (
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-serif font-bold text-primary-800 mb-6">
              {t('industry.healthcare.bottomCta.title')}
            </h2>
            
            <p className="text-lg text-secondary-700 mb-8 max-w-3xl mx-auto">
              {t('industry.healthcare.bottomCta.description')}
            </p>
            
            <Link to="/contact" className="btn btn-primary">
              {t('industry.healthcare.bottomCta.buttonText')}
            </Link>
          </div>
        </div>
      </section>
