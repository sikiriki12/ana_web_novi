...
export default function ITIndustry() {
  ...
  const services = t('industry.it.services.items');
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center mb-6 text-primary-300">
              <Link to="/industry" className="hover:text-white transition-colors">
                {t('industry.it.breadcrumb')}
              </Link>
              <span className="mx-3">/</span>
              <span>{t('industry.it.title')}</span>
            </div>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h2 className="text-3xl font-serif font-bold text-primary-800 mt-0 mb-4">
                      {t('industry.it.intro.title')}
                    </h2>
                    
                    <p>
                      {t('industry.it.intro.paragraph1')}
                    </p>
                    
                    <p>
                      {t('industry.it.intro.paragraph2')}
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-primary-50 rounded-xl p-8 my-10">
                  <h3 className="text-2xl font-serif font-bold text-primary-800 mb-6">
                    {t('industry.it.approach.title')}
                  </h3>
                  
                  <p>
                    {t('industry.it.approach.paragraph1')}
                  </p>
                  
                  <p className="mb-0">
                    {t('industry.it.approach.paragraph2')}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  {services.map((service, index) => {
                    ...
                    const iconMap = {
                      0: <FaLaptopCode size={20} />,
                      1: <FaGavel size={20} />,
                      2: <FaUserTie size={20} />,
                      3: <FaFileContract size={20} />
                    };
            ...
            <div className="md:col-span-4">
              ...
              <div className="bg-primary-800 text-white rounded-xl p-8 mb-8">
                <h3 className="text-xl font-serif font-bold mb-4">
                  {t('industry.it.sidebar.cta.title')}
                </h3>
                
                <p className="text-primary-100 mb-6">
                  {t('industry.it.sidebar.cta.description')}
                </p>
              ...
              <div className="bg-primary-50 rounded-xl p-8">
                <h3 className="text-xl font-serif font-bold text-primary-800 mb-4">
                  {t('industry.it.sidebar.whyChooseUs.title')}
                </h3>
                
                <ul className="space-y-4">
                  {t('industry.it.sidebar.whyChooseUs.reasons').map((reason, index) => (
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-serif font-bold text-primary-800 mb-6">
              {t('industry.it.bottomCta.title')}
            </h2>
            
            <p className="text-lg text-secondary-700 mb-8 max-w-3xl mx-auto">
              {t('industry.it.bottomCta.description')}
            </p>
            
            <Link to="/contact" className="btn btn-primary">
              {t('industry.it.bottomCta.buttonText')}
            </Link>
          </div>
        </div>
      </section>
