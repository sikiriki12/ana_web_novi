          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center mb-6 text-primary-300">
              <Link to="/practice-areas" className="hover:text-white transition-colors">
                {t('contractLaw.breadcrumb')}
              </Link>
              <span className="mx-3">/</span>
              <span>{t('contractLaw.title')}</span>
            </div>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="inline-flex items-center mb-4">
                  ...
                  <h2 className="text-3xl font-serif font-bold text-primary-800 m-0">
                    {t('contractLaw.ourServices')}
                  </h2>
                </div>
                
                <p>
                  {t('contractLaw.introText')}
                </p>
                
                <h3 className="text-2xl font-serif font-bold text-primary-800 mt-8 mb-4">
                  {t('contractLaw.drafting.title')}
                </h3>
                
                <p>
                  {t('contractLaw.drafting.description')}
                </p>
                
                <ul>
                  {t('contractLaw.drafting.items').map((item, index) => (
                    <li key={index}>{item}</li>
                  ))}
                </ul>
                
                <h3 className="text-2xl font-serif font-bold text-primary-800 mt-8 mb-4">
                  {t('contractLaw.negotiation.title')}
                </h3>
                
                <p>
                  {t('contractLaw.negotiation.description')}
                </p>
                
                <h3 className="text-2xl font-serif font-bold text-primary-800 mt-8 mb-4">
                  {t('contractLaw.disputes.title')}
                </h3>
                
                <p>
                  {t('contractLaw.disputes.description')}
                </p>
                
                <ul>
                  {t('contractLaw.disputes.items').map((item, index) => (
                    <li key={index}>{item}</li>
                  ))}
                </ul>
                
                <h3 className="text-2xl font-serif font-bold text-primary-800 mt-8 mb-4">
                  {t('contractLaw.management.title')}
                </h3>
                
                <p>
                  {t('contractLaw.management.description')}
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-1">
              ...
              <div className="bg-primary-800 text-white rounded-xl p-8">
                <h3 className="text-xl font-serif font-bold mb-4">
                  {t('contractLaw.sidebar.title')}
                </h3>
                
                <p className="mb-6 text-primary-100">
                  {t('contractLaw.sidebar.description')}
                </p>
